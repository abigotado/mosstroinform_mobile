...
abstract class IFinalDocumentRemoteDataSource {
  ...
  Future<ConstructionCompletionStatusModel> getCompletionStatus(String projectId);
  ...
  Future<FinalDocumentModel> getFinalDocumentById(String projectId, String documentId);
